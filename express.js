...
var command=require("./liguo/command/LiguoCommand");

liguo.app=express();
liguo.bodyParser=require('body-parser');
liguo.app.use(liguo.bodyParser.json({limit:'500mb'}));
liguo.app.use(liguo.bodyParser.urlencoded({limit: '500mb', extended: true}))
...
liguo.app.use(express.static("liguo/device"));
